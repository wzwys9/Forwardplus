...
export const EXTERNAL_PROXY_FORWARD_TYPES = ["iptables", "nftables", "realm", "socat", "gost", "nginx"] as const satisfies readonly ForwardType[];
export type ExternalProxyForwardType = (typeof EXTERNAL_PROXY_FORWARD_TYPES)[number];

const externalProxyForwardTypeSet = new Set<string>(EXTERNAL_PROXY_FORWARD_TYPES);

export function isExternalProxyForwardType(value: unknown): value is ExternalProxyForwardType {
  return typeof value === "string" && externalProxyForwardTypeSet.has(value);
}
