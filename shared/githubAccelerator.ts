...
export const PANEL_INSTALLER_REPOSITORY_PATHS: Record<PanelInstallerDeployment, string> = {
  local: "scripts/install-panel-local.sh",
  docker: "scripts/install-panel-docker.sh",
};
