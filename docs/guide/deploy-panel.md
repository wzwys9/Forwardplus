...
docker image ls --no-trunc --format '{{.Repository}} {{.Tag}} {{.ID}}' ghcr.io/wzwys9/forwardplus \
  | awk -v current="$CURRENT_IMAGE_ID" '$1 == "ghcr.io/wzwys9/forwardplus" && $2 != "<none>" && $3 != current { print $1 ":" $2 }' \
